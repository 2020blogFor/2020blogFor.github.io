...
\includegraphics[width=8cm]{../../../../images/blog_images/metaL/NTM.PNG}
...
\includegraphics[width=8cm]{imagesRecentAdvances/objective_func.png}
...
\includegraphics[width=8cm]{imagesRecentAdvances/MAML_general.png}
...
\includegraphics[width=8cm]{imagesRecentAdvances/grad_intuition.png}
...
\includegraphics[width=8cm]{imagesRecentAdvances/MAML-supervised.png}

For discrete classification tasks with cross-entropy loss:

\includegraphics[width=8cm]{imagesRecentAdvances/MAML_cross-entropy.png}

These loss functions can be inserted into Algorithm 2:

\includegraphics[width=8cm]{imagesRecentAdvances/MAML_alg2.png}
...
\includegraphics[width=8cm]{meta-rl.PNG}
